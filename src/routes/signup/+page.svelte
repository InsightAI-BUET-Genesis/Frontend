<script lang="ts">
	...
	import consumer_signup from '$lib/assets/consumer_signup.gif';
    ...
    <section class="flex-1 flex items-center justify-center bg-gradient-to-b from-purple-100 to-indigo-200 dark:from-gray-900 dark:to-indigo-900">
        <div class="w-[90%] max-w-4xl my-8 bg-white bg-opacity-95 rounded-lg shadow-2xl overflow-hidden">
            <div class="grid md:grid-cols-5">
                <div class="bg-[#190c40] md:col-span-2 flex flex-col items-center justify-center p-8">
                    <img src={consumer_signup} alt="Consumer Signup" class="w-[180px] md:w-[250px] mb-6 animate-float" />
                ...
                <div class="md:col-span-3 flex items-center justify-center p-8">
                    <div class="w-full max-w-md">
                        <h2 class="text-3xl font-bold mb-6 text-indigo-900">Create an Account</h2>
                        <form
                            use:enhance
                            action="?/register"
                            method="post"
                        ...
                        >
                            {#if $message}
                                <div class="p-3 rounded-sm text-base {$message === 'SignUp Successful. Check Inbox' ? 'text-green-700 border-green-500 bg-green-100 border' : 'text-red-700 border-red-500 bg-red-100 border'}">
                                    {$message}
                                </div>
                            {/if}
