...
<script>
	...
	async function handleSendMessage(event) {
		...
		try {
			const response = await apiService.postPython('chats/on-collection', payload);
...
<div class="font-poppins container mx-auto px-4 py-12">
	{#if collection}
		...
		<div class="flex flex-col items-center">
			<div
				class="flex w-full max-w-5xl flex-col overflow-hidden rounded-lg bg-white shadow-xl lg:flex-row"
			>
				<!-- Sidebar -->
				<div
