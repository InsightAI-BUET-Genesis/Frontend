...
<div class="font-poppins container mx-auto px-4 py-12">
	{#if product && reviews}
		...
		<div class="mt-12">
			<h2 class="mb-6 text-3xl font-bold text-gray-900 dark:text-white">Product Reviews</h2>
		...
		{#if similarProducts && similarProducts.length > 0}
			<div class="mt-12">
				<h2 class="mb-6 text-3xl font-bold text-gray-900 dark:text-white">Similar Products</h2>
